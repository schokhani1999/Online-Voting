	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(src == btnS) {
			try {
				...
				stmt.executeUpdate("create table if not exists AITCTb(Candidate_ID varchar(50), Name varchar(150), Photo longblob, Role varchar(100), DoB date, Join_Year int, Belongs varchar(100), Gender varchar(50), Leader varchar(50))");
				PreparedStatement pstmt = con.prepareStatement("insert into AITCTb(Candidate_ID, Name, Photo, Role, DoB, Join_Year, Belongs, Gender, Leader) values(?, ?, ?, ?, ?, ?, ?, ?, ?)");
